...
wget -O /usr/local/bin/ws-dropbear https://raw.githubusercontent.com/wahyuyaw/vps/master/sshws/ws-dropbear
wget -O /usr/local/bin/ws-stunnel https://raw.githubusercontent.com/wahyuyaw/vps/master/sshws/ws-stunnel
