...
# domain random
CDN="https://raw.githubusercontent.com/wahyuyaw/vps/master/ssh"
cd /root
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/wahyuyaw/vps/master/menu/versi  )
...
echo "---------------------------t.me/wahyuyaw-----------------------------" | tee -a log-install.txt
echo "==================================================================" | tee -a log-install.txt
echo -e ""
echo ""
echo "" | tee -a log-install.txt
