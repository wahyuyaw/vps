...
# domain random
CDN="https://raw.githubusercontent.com/wahyuyaw/coba/master/ssh"
cd /root
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/wahyuyaw/coba/master/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
echo -e "\e[33m-----------------------------------\033[0m"
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/wahyuyaw/coba/master/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
wget https://raw.githubusercontent.com/wahyuyaw/coba/master/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
...
echo "--------------------------081323454890----------------------------" | tee -a log-install.txt
echo "==================================================================" | tee -a log-install.txt
echo -e ""
echo ""
echo "" | tee -a log-install.txt
